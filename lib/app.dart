...
class AppState extends State<App>
  ...
  void _onLogout({
    ...
    unawaited(_user.logout());
    if (isRequiredLogin || Services().widget.isRequiredLogin) {
      printLog('[AppState] Redirecting to Login and clearing navigation stack');
      App.fluxStoreNavigatorKey.currentState?.pushNamedAndRemoveUntil(
        RouteList.login,
        (route) => false,
      );
    }
