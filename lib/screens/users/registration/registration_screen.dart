...
class _RegistrationScreenMobileState extends State<RegistrationScreenMobile>
  ...
  void _welcomeDiaLog(User user) {
        ...
        MaterialPageRoute(
          builder: (ctx) => VendorOnBoarding(
            ...
            onFinish: () {
              ...
              // Standardized navigation to dashboard
    ...
    // Standardized navigation to dashboard to ensure stability
                            ...
                            Padding(
                              ...
                              child: Material(
                                ...
                                child: MaterialButton(
                                  ...
                                  // Button is disabled when loading=true, preventing
                                  // multiple simultaneous signup calls
