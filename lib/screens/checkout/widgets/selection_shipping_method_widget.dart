...
class SelectionShippingMethodWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Since filtering is done at the parent level, just show this shipping method
    // The parent widget handles filtering for Flat Rate vs other types
        ...
        child: Column(
          children: <Widget>[
            Container(
              decoration: BoxDecoration(
                color: useDesktopStyle
                    ...
                    : (isSelected
                        ...
                        : Colors.transparent),
                borderRadius:
                    useDesktopStyle ? BorderRadius.circular(10) : null,
              ...
              margin:
                  useDesktopStyle ? const EdgeInsets.only(bottom: 16) : null,
              child: Padding(
                padding:
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    if (useDesktopStyle) ...[
                      const FluxImage(
                          imageUrl: 'assets/icons/payment/truck.svg'),
