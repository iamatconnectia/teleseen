...
class _CheckoutState extends BaseScreen<Checkout> {
  ...
  void afterFirstLayout(BuildContext context) {
    if (!kPaymentConfig.enableAddress) {
      setState(() {
        tabIndex = 1; // Skip to Review (now 1)
      });
      if (!kPaymentConfig.enableReview) {
        setState(() {
          tabIndex = 2; // Skip to Payment (now 2)
          isPayment = true;
        });
      }
    }
    ...
    Widget progressBar = Row(
      ...
      children: <Widget>[
        kPaymentConfig.enableAddress
            ...
            : const SizedBox(),
        // Shipping step removed as requested
              ...
              child: Align(
                ...
                child: StepperCheckoutWidget(
                  ...
                  items: [
                    ...
                    StepperCheckoutItem(
                      index: 1, // Review is now 1 in stepper
                      title: S.of(context).review.toTitleCase(),
                    ),
                    StepperCheckoutItem(
                      index: 2, // Payment is now 2 in stepper
