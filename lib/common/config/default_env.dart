...
class DefaultConfig {
  ...
  static String appName = 'TeleSeen';
  ...
  static Map advanceConfig = {
    ...
    'SupportPageUrl': 'https://ktskw.com/contact-us/',

    'DownloadPageUrl': 'https://ktskw.com',
    'AboutUSPageUrl': 'https://ktskw.com/about-us/',
    'NewsPageUrl': 'https://ktskw.com',
    'FAQPageUrl': 'https://ktskw.com',

    'SocialConnectUrl': [
      {
        'name': 'Facebook',
        'icon': 'assets/icons/logins/facebook.png',
        'url': 'https://www.facebook.com/TeleSeen'
      },
      {
        'name': 'Instagram',
        'icon': 'assets/icons/logins/instagram.png',
        'url': 'https://www.instagram.com/TeleSeen'
      },
    ],
