...
//Sync cart to website
  ...
  Widget renderShippingMethodInfo(BuildContext context,
    ...
    final shippingCost = model.getShippingCost(includeTax: true) ?? 0.0;
    final hasShipping = model.isEnabledShipping() && (model.shippingMethod != null || shippingCost > 0);
    return hasShipping
        ? Padding(
            padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
            child: Row(
              ...
              children: <Widget>[
                Expanded(
                  child: Text(
                    model.shippingMethod?.title?.toString() ?? S.of(context).shipping,
