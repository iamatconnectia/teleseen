...
class WalletServicesImpl implements WalletServices {
  ...
  @override
  Future<List<WalletRequest>?> getApprovedRequests({required String token}) async {
    return [];
  }

  @override
  Future<List<WalletRequest>?> getCancelledRequests({required String token}) async {
    return [];
  }
  ...
  @override
  Future<List<WalletRequest>?> getPendingRequests({required String token}) async {
    return [];
  }
