...
abstract class BaseServices {
  ...
  Future<User?> loginFacebook({String? token}) async => null;

  Future<User?> loginSMS({String? token}) async => null;
  ...
  Future<User?> loginGoogle({String? token}) async => null;
  ...
  Future<double> calculateShipping(int zoneId) async => 0.0;
  ...
  Future updateOrder(orderId, {status, required token}) async => null;

  Future deleteOrder(orderId, {required token}) async => null;
  ...
  Future<User?> getUserInfo(cookie) async => null;
  ...
  Future<Product?> overrideGetProduct(id) async => getProduct(id);
  ...
  Future createReview(ReviewPayload payload) async => null;

  Future<Map<String, dynamic>?> getHomeCache(String? lang) async => null;
  ...
  Future getCategoryWithCache() async => null;
  ...
  Future<Map<String, dynamic>?> getCurrencyRate() async => null;

  Future<List<dynamic>?> getCartInfo(String? token) async => null;

  Future syncCartToWebsite(CartModel cartModel, User? user) async => null;

  Future<Map<String, dynamic>?> getCustomerInfo(String? id) async => null;

  Future<CartTax?> getTaxes(CartModel cartModel, String? token) async => null;
