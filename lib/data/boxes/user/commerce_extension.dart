...
extension UserCommerceSettingsExtension on UserBox {
  ...
  double get savedShippingCost {
    return box.get(BoxKeys.savedShippingCost, defaultValue: 0.0);
  }

  set savedShippingCost(double value) {
    box.put(BoxKeys.savedShippingCost, value);
  }
}
